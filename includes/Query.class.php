 ...
 *
 * Queries return an array of wtbBooking objects.
 *
 * @since 1.4.1
 */
class wtbQuery {
	...
	public function __construct( $args = array(), $context = '' ) {
		...
		$defaults = array(
			...
			'posts_per_page'	=> 10,
			'date_range'		=> 'upcoming',
			'post_status'		=> array_keys( $wtb_controller->cpts->booking_statuses ),
			'order'				=> 'ASC',
			'paged'				=> 1,
		);
	...
	public function get_bookings() {
		...
		$args = apply_filters( 'wtb_query_args', $this->args, $this->context );
