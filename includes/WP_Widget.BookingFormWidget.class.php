...
if ( !class_exists( 'wtbBookingFormWidget' ) ) {
/**
 * Booking form widget
 *
 ...
 * @since 0.0.1
 */
class wtbBookingFormWidget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'wtb_booking_form_widget',
			__('Booking Form', 'wp-table-bookings'),
			array( 'description' => __( 'Display a form to accept bookings.', 'wp-table-bookings' ), )
		);
